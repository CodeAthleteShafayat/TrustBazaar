...
begin
  ...
  -- Photo URLs below are verified (fetched + visually inspected) to actually depict the item —
  -- earlier Unsplash IDs picked blind resolved to unrelated photos (a laptop for "ceiling fan", etc).
  insert into public.listings (seller_id, title, category, listing_type, price, description, photo_urls, status)
  values
    (seller_id, 'Preowned study chair',                  'furniture',           'sale',  1200.00, 'Sturdy wooden study chair, light wear, no wobble.', ARRAY['https://images.unsplash.com/photo-1592078615290-033ee584e267?w=800'], 'active');
  insert into public.listings (seller_id, title, category, listing_type, price, description, photo_urls, status)
  values
    (seller_id, 'Preowned study table',                  'furniture',           'sale',  2800.00, 'Compact study table, some scuffs on the surface, sturdy legs.', ARRAY['https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=800'], 'active');
  insert into public.listings (seller_id, title, category, listing_type, price, description, photo_urls, status)
  values
    (seller_id, 'Ceiling fan (used)',                    'electronics',         'sale',  1500.00, '56-inch ceiling fan, works perfectly, removed during room renovation.', ARRAY['https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Modern_ceiling_fan.jpg/500px-Modern_ceiling_fan.jpg'], 'active');
  insert into public.listings (seller_id, title, category, listing_type, price, description, photo_urls, status)
  values
    (seller_id, 'Water filter (used)',                   'other',               'sale',  2200.00, 'Tabletop water filter with new candle installed last month.', ARRAY['https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Brita_water_pitcher.png/500px-Brita_water_pitcher.png'], 'active');
  insert into public.listings (seller_id, title, category, listing_type, price, description, photo_urls, status)
  values
    (seller_id, 'Study lamp — LED',                      'electronics',         'sale',   450.00, 'Adjustable LED study lamp, 3 brightness levels, USB powered.', ARRAY['https://images.unsplash.com/photo-1507473885765-e6ed057f782c?w=800'], 'active');
  insert into public.listings (seller_id, title, category, listing_type, price, description, photo_urls, status, rent_per_day, deposit_required, deposit_rate)
  values
